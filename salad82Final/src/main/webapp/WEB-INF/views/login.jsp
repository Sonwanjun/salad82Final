...
<table id="loginbox">
<tr>
<td>아이디</td> <td><input type = "text" name = "id" placeholder = "아이디" required></td><td>${check}</td>
</tr>
<tr>
<td>비밀번호</td> <td><input type = "password" name = "pwd" placeholder="비밀번호" required></td>
</tr>
<tr>
<td><button>로그인</button></td> 
<td><a href="./loginform">회원가입</a>
<a href="#search" onclick="articleView()"> 아이디/비밀번호 찾기</a></td>
</tr>
</table>
</form>
	<div id="articleView_layer">
		...
		<button id="loginTry">확인</button><br><br><br><br><br>
		비밀번호찾기<br>
